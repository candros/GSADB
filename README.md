...
An example jupyter notebook is contained in the repository and is called "Example.ipynb". The other notebook called "trainer.ipynb" is included for reproducibility, in case a user wishes to review the code that generated and trained the models described in the manuscript.
